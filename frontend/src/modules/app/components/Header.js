...
import {SelectCinema} from '../../showtimes';
                ...
                <ul className="navbar-nav">
                    ...
                    {isUserRole &&
                        <li className="nav-item">
                            <Link className="nav-link" to="/shopping/find-sales">
                                <FormattedMessage id="project.shopping.header.sales"/>
                            </Link>
                        </li>
                    }
                    ...
                    {isTicketSellerRole &&
                        <li className="nav-item">
                            <Link className="nav-link" to="/shopping/deliver-tickets">
